...
##---------------------------
print("Starting...")
print(t_srs, stepsize, substepsize, connected, outfile)
##---------------------------
...
if not connected:
    ...
    stepsize = 0.25 ## TODO: FIX HARDCODE SOLUTION
    for lat in float_range(ymin,ymax+stepsize/2,stepsize):
        for long_ in float_range(xmin,xmax-substepsize/2,stepsize):
    ...
    stepsize = 0.33333333333 ## TODO: FIX HARDCODE SOLUTION
